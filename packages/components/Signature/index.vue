...
export default defineComponent({
  ...
  mounted() {
    ...
    this.resizeCanvas()
    if (options.beginStroke) {
      signaturePad.addEventListener('beginStroke', options.beginStroke.bind(this))
    }
    if (options.endStroke) {
      signaturePad.addEventListener('endStroke', options.endStroke.bind(this))
    }
  },
  beforeUnmount() {
