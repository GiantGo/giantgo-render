...
export declare type Interpolation<T> = {
...
export declare type RequiredRule = {
    required: boolean;
    message: string;
    trigger: string;
};
export declare type PatternRule = {
    pattern: string;
    message: string;
    trigger: string;
};
export declare type Rules = [required: RequiredRule, ...prop: Array<PatternRule>];
...
export declare type FormDesignRegister = (name?: string, components?: Array<FormDesign>, order?: number) => void;
